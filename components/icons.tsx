...
export const ShareIcon = ({ size = 16 }: { size?: number }) => {
	return (
		...
		>
			<path
				d="M12 6.25C12.4142 6.25 12.75 5.91421 12.75 5.5C12.75 5.08579 12.4142 4.75 12 4.75V6.25ZM19.75 12.5C19.75 12.0858 19.4142 11.75 19 11.75C18.5858 11.75 18.25 12.0858 18.25 12.5H19.75ZM19 6.25C19.4142 6.25 19.75 5.91421 19.75 5.5C19.75 5.08579 19.4142 4.75 19 4.75V6.25ZM14.912 4.75C14.4978 4.75 14.162 5.08579 14.162 5.5C14.162 5.91421 14.4978 6.25 14.912 6.25V4.75ZM19.75 5.5C19.75 5.08579 19.4142 4.75 19 4.75C18.5858 4.75 18.25 5.08579 18.25 5.5H19.75ZM18.25 9.641C18.25 10.0552 18.5858 10.391 19 10.391C19.4142 10.391 19.75 10.0552 19.75 9.641H18.25ZM19.5303 6.03033C19.8232 5.73744 19.8232 5.26256 19.5303 4.96967C19.2374 4.67678 18.7626 4.67678 18.4697 4.96967L19.5303 6.03033ZM11.4697 11.9697C11.1768 12.2626 11.1768 12.7374 11.4697 13.0303C11.7626 13.3232 12.2374 13.3232 12.5303 13.0303L11.4697 11.9697ZM12 4.75H9V6.25H12V4.75ZM9 4.75C6.37665 4.75 4.25 6.87665 4.25 9.5H5.75C5.75 7.70507 7.20507 6.25 9 6.25V4.75ZM4.25 9.5V15.5H5.75V9.5H4.25ZM4.25 15.5C4.25 18.1234 6.37665 20.25 9 20.25V18.75C7.20507 18.75 5.75 17.2949 5.75 15.5H4.25ZM9 20.25H15V18.75H9V20.25ZM15 20.25C17.6234 20.25 19.75 18.1234 19.75 15.5H18.25C18.25 17.2949 16.7949 18.75 15 18.75V20.25ZM19.75 15.5V12.5H18.25V15.5H19.75ZM19 4.75H14.912V6.25H19V4.75ZM18.25 5.5V9.641H19.75V5.5H18.25ZM18.4697 4.96967L11.4697 11.9697L12.5303 13.0303L19.5303 6.03033L18.4697 4.96967Z"
				fill="currentColor"
			/>
		</svg>
	)
